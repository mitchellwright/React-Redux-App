...
const HeroInfoButton = ({ heroInput, isFetching, getHero }) => {
  const handleClick = (e) => {
    e.preventDefault();
    console.log(`HandleClick: ${heroInput}`);
    getHero(heroInput);
  };
...
export default connect(mapStateToProps, mapDispatchToProps)(HeroInfoButton);
